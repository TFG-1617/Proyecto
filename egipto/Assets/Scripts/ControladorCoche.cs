...
public class ControladorCoche : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        CharacterController controller = GetComponent<CharacterController>();
            ...
            moveDirection = new Vector3(0, 0, (Input.acceleration.x + Input.GetAxis("Horizontal")) * speedTurn);
            moveDirection = transform.TransformDirection(moveDirection);
            moveDirection *= speed;
            giroEnY = (Input.acceleration.x + Input.GetAxis("Horizontal")) * anguloDeGiro;
